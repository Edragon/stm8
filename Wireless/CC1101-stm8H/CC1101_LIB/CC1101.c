...
/*==============================================================================
*	Function 		: RfWriteReg()
*	Description	:	Set the RF device register
================================================================================
*/
void RfWriteReg(void)
{
		...
		halRfWriteReg(CC1101_WORCTRL,0xFB);//Wake On Radio Control
...
{ 
    ...
    CC1101ClrTXBuff();
    CC1101WriteReg(CC1101_IOCFG0,0x06); //GDO0 Output Pin Configuration
    ...
    CC1101WriteReg(CC1101_IOCFG0,0x01); //GDO0 Output Pin Configuration
}
